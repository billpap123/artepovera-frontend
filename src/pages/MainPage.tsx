...
import { 
  ...
  FaPlusCircle, FaCommentDots, FaImages, FaUsersCog, FaThList 
} from 'react-icons/fa';
    ...
    <>
      ...
      <div className="main-page-container">
        ...
        <div className="dashboard-grid">
          ...
          {/* Job Feed & Map Area (hidden for Admins) */}
          {userType !== 'Admin' && (
            <>
              <div className="dashboard-card job-feed-card">
                {/* Render the new JobFilters component and pass it the handler */}
                <JobFilters onFilterChange={handleFilterChange} />
                <hr className="filter-divider" />
                {/* Render the new JobFeed component and pass it the filtered data */}
