...
const landingPageStyles = `
  ...
  .landing-page-container .language-switcher-select {
  ...
  .landing-page-container .language-switcher-select:hover {
    background-color: rgba(255, 255, 255, 0.25);
  }

  /* Ensures the dropdown options are readable */
  .landing-page-container .language-switcher-select option {
